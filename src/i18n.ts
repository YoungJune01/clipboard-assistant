...
export const messages = {
  zh_cn: {
    ...
    storage: "本地保存", retention: "保存期限", retentionDetail: "到期内容会从本机数据库和当前列表中删除",
    oneDay: "1 天", sevenDays: "7 天", thirtyDays: "30 天", ninetyDays: "90 天", forever: "永久保存",
  ...
  en: {
    ...
    storage: "Local storage", retention: "Keep history for", retentionDetail: "Expired items are removed from this PC and the current list",
    oneDay: "1 day", sevenDays: "7 days", thirtyDays: "30 days", ninetyDays: "90 days", forever: "Forever",
